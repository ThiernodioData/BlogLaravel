        ...
        <div class="container" data-aos="fade-up">
          ...
          <article class="article">
            ...
            <div class="hero-img" data-aos="zoom-in">
              <img src="{{ asset($article['image']) }}" alt="Featured blog image" class="img-fluid" loading="lazy">
              <div class="meta-overlay">
                <div class="meta-categories">
                  <a href="#" class="category">{{ $article['category'] }}</a>
                  <span class="divider">•</span>
                  <span class="reading-time"><i class="bi bi-clock"></i>{{ $article['date'] }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="article-content" data-aos="fade-up" data-aos-delay="100">
              <div class="content-header">
                ...
                <div class="author-info">
                  ...
                  <img src="{{ asset($article['author_image']) }}" alt="Author" class="author-img">
              ...
              <div class="content">
                ...
                <div class="content-image right-aligned">
                  <img src="{{ asset($article['image']) }}" class="img-fluid" alt="Modern web development tools" loading="lazy">
          ...
          <div class="author-box">
            <div class="row align-items-center">
              <div class="col-lg-3 col-md-4 text-center">
                <img src="{{ asset($article['author_image']) }}" class="author-img rounded-circle" alt="" loading="lazy">
            ...
            <div class="comments-wrapper">
              ...
              <article class="comment-card">
                <div class="comment-header">
                  <div class="user-info">
                    <img src="{{ asset($article['author_image']) }}" alt="User avatar" loading="lazy">
                    <div class="meta">
                      <h4 class="name">{{ $article['author'] }}</h4>
              ...
              <article class="comment-card">
                <div class="comment-header">
                  <div class="user-info">
                    <img src="{{ asset('assets/img/person/person-m-9.webp') }}" alt="User avatar" loading="lazy">
                    <div class="meta">
                ...
                <div class="reply-thread">
                  ...
                  <article class="comment-card reply">
                    <div class="comment-header">
                      <div class="user-info">
                        <img src="{{ asset('assets/img/person/person-f-9.webp') }}" alt="User avatar" loading="lazy">
                        <div class="meta">
                  ...
                  <article class="comment-card reply">
                    <div class="comment-header">
                      <div class="user-info">
                        <img src="{{ asset('assets/img/person/person-f-7.webp') }}" alt="User avatar" loading="lazy">
                        <div class="meta">
              ...
              <article class="comment-card">
                <div class="comment-header">
                  <div class="user-info">
                    <img src="{{ asset('assets/img/person/person-m-6.webp') }}" alt="User avatar" loading="lazy">
                    <div class="meta">
